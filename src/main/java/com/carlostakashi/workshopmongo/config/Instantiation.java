...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("21/03/2018"), "partiu viagem", "vou viajar para campinas, abraços", maria);
        Post post2 = new Post(null, sdf.parse("05/10/2018"), "partiu estudar", "bora facul rpzd", maria);
